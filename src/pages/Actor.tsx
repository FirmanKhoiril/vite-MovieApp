        ...
        isSuccess && (
          <>
            <Box sx={{ display: "flex", flexDirection: { md: "row", xs: "column" }, py: 4, justifyContent: "space-between", alignItems: "center", gap: 4 }}>
              <LazyLoadImage src={`https://image.tmdb.org/t/p/original/${data?.profile_path}`} alt={data?.name} loading="lazy" effect="opacity" className="w-[440px] h-[540px] rounded-lg shadow-[2px_12px_20px_5px] shadow-white/50" />
