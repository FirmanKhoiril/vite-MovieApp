...
const SearchBar = () => {
  ...
  return (
    <form className=" relative" onSubmit={handleSubmit}>
      ...
      />
      <button type="submit" className="py-[8px] px-4 absolute right-0 top-0 bg-white text-white transition__all bg-gradient-to-r from-red-500 via-red-400 to-pink-400 peer-focus:bg-white/5 rounded-full tracking-wide">
        Search
      </button>
    </form>
  );
